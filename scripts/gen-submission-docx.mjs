...
const children = [
  ...
  B('**근거(지식)**: 분류 기준 문서 + 사내 SharePoint·Teams·메일·FAQ를 지식으로 연결해 출처 기반 응답'),
  ...
  B('지식·지시문 문서: voc-classification-knowledge.docx(분류 기준) · voc-selfguide-agent.docx(셀프가이드 에이전트 지시문·지식)'),
]
