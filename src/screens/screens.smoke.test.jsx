...
describe('화면 렌더 스모크 — 데이터 있음', () => {
  ...
  it('InsightReport', () => render(<InsightReport added={data} openCase={noop} />))
  it('VOCInbox', () => render(<VOCInbox openCase={noop} notify={notify} added={data} setAdded={noop} shared={false} sharedInsert={noop} />))
  it('CaseDetail', () => render(<CaseDetail caseId="VOC-1" notify={notify} added={data} updateCases={noop} addSent={noop} openCase={noop} />))
})
